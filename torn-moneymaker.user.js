...
(function () {
    ...
    const TTV2_BUILD_VERSION = '3.7.0';
     ...
     */
    function rankTraders(traders, { presenceOf = () => null, marketValue = 0 } = {}) {
     ...
     */
    function buildTraderBoard(rows, tradersMap, { presenceOf = () => null } = {}) {
     ...
     */
    function decorateBoardEntry(entry) {
